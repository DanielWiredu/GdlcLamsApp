...
namespace BusinessLogic.Repository.IRepository
{
    public interface IDailyReqRepository
    {
        ...
        Task<IEnumerable<VmApprovedGPHARequest>> GetGPHAApprovedRequests(DateTime StartDate, DateTime EndDate, bool GdlcApproved, string SearchValue);
        Task<IEnumerable<VmApprovedGPHARequest>> GetGPHARequests(DateTime StartDate, DateTime EndDate);
